...
public class PDFgenerator {
    ...
    public  void generatePDF(String filePath, String name, String emailId, String phone, String operatingAirlines, Date departureDate, String departureCity, String arrivalCity,String firstName) {
        try {
            Document document = new Document();
            PdfWriter.getInstance(document, new FileOutputStream(filePath));
            document.open();
            addMetaData(document,firstName);
    ...
    private static void addMetaData(Document document,String firstName) {
        document.addTitle("Flight Ticket "+firstName+"");
